...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V = list()
  V[["A1"]]  = b_deaths * A1_DEATHS + b_qol * A1_QOL + b_premium * A1_PREM + b_taboo * A1_TABOO
  V[["A2"]]  = b_deaths * A2_DEATHS + b_qol * A2_QOL + b_premium * A2_PREM + b_taboo * A2_TABOO
  V[["A3"]]  = asc_sq + b_qol * A3_QOL + b_taboo * A3_TABOO
