...
file_path = "./data/experiment1/healthinsurance_dce_raw.csv"
file_save = "./data/experiment1/healthinsurance_dce.csv"

# Load data
data = read.csv(file_path, header=TRUE)

# Generate dummies for all covariates
dummy_cols_list = c("UNCERTAIN", "AGE", "EDUC", "HH_INC", "HH_COMP", "ALTRUISM", "RISKAVERS_1", "RISKAVERS_2",
